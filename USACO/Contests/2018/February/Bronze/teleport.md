This one was unusually easy, probably the easiest Bronze I've done so far, which is pretty weird. Let's say the points are start, end, teleport1, teleport2. There's only three possible cases. 
